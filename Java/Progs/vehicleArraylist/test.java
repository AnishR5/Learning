...
public class test {
	...
	public static void main(String[] args) throws VehicleInvalidException {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			while (!exit) {
				System.out.println(
						"1.Add vehicle\n2.Display vehicles\n3.Display details of Specific Vehicle\n4.Discount\n5.Delete Vehicle\n6.Delete vehicle of color\n7.Sort by chasisno\n8.Sort by Price\n9.Sort by Date-->Price\n10.Exit");
				ch = sc.nextInt();
				try {
					switch (ch) {
						case 1: {
							...
							Vehicle newv = validateAllValidations(sc.next(), sc.next(), sc.next(), sc.nextDouble(),
									sc.next(), showroom);
							// showroom[index++]=newv;
							showroom.add(newv);
						...
						case 3: {
							...
							// i/p : chasis no
							// o/p : either vehicle details (in case of vehicle found) or err mesg via
							// custom exc!
						...
						case 6: {// remove vehicle with entered color
							...
							// {
							// if(showroom.get(i).getColor()==selclr)
							// {
